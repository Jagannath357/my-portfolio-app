function About() {
    return ( 
        <div className="container d-flex justify-content-center mt-5 mb-5" id="aboutContainer">
                ...
                <div className="row gap-5">
                    <div className="col-12">
                        ...
                        <p className="ps-2 pe-2 text-center fs-5">
                            ...
                            I'm currently pursuing a degree in Computer Science, and over the past year, I've developed a strong passion for front-end development. I enjoy transforming design concepts into clean, responsive, and user-friendly websites using HTML, CSS, JavaScript, and React. <br /> <br />
